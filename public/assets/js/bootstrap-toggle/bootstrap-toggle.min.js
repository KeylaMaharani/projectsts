+function(a) {
    ...
    c.VERSION = "2.2.0",
        ...
        c.prototype.render = function() {
            ...
            var b = "large" === this.options.size ? "btn-lg" :
                "small" === this.options.size ? "btn-sm" :
                "mini" === this.options.size ? "btn-xs" : "",
        ...
        c.prototype.trigger = function(b) {
            this.$element.off("change.bs.toggle"),
                ...
                this.$element.on("change.bs.toggle", a.proxy(function() {
                    this.update()
                }, this))
        },
