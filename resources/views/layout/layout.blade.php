    ...
    ***********************************-->
    <div id="main-wrapper">
            ...
            <div class="brand-logo">
                <a href="index.html">
                    ...
                    <span class="brand-title">
                        <div class="navbar-brand" style="color: white; font-weight: bold;">KASIR</div>
                    </span>
                </a>
            </div>
        </div>
                    ...
                    <ul class="clearfix">
                        <li class="icons dropdown">
                            <div class="user-img c-pointer position-relative" data-toggle="dropdown">
                                ...
                                <img src="/assets/images/user/key.jpg" height="40" width="40" alt="">
                            </div>
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright &copy; Designed & Developed by <a href="#">KEY</a> 2024</p>
            </div>
        </div>
        <!--**********************************
            Footer end
